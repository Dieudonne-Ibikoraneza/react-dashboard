            ...
            <>
              <Popover.Button
                className={classNames(
                  open && "bg-gray-100",
                  "p-1.5 rounded text-gray-700 inline-flex items-center text-opacity-100 focus:outline-none active:bg-gray-100"
                )}
              >
        ...
        <Menu as="div" className="relative">
          <div className="inline-flex">
            <Menu.Button className="ml-2 rounded-full focus:outline-none focus:ring-2 focus:ring-neutral-400">
              ...
              <div
                className="h-10 w-10 rounded-full bg-sy-500 bg-cover bg-no-repeat bg-center"
                style={{
                  backgroundImage:
                    'url("https://source.unsplash.com/80x80/face)',
                }}
              >
                <span className="sr-only">Dieudonne</span>
              </div>
            </Menu.Button>
          </div>
          <Transition
